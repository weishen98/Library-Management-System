...
<body>
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <br>
                    <a href="issueBook.php" class="btn">Issue Book &#8594;</a>
                </div>
    ...
    <div class="services">
        <div class="small-container">
            <div class="row">
                <div class="col-4"><a class="" href="issueBook.php"><img src="images/issue books.png"></a><br>
                    <h3>Issue Book</h3>
                </div>

                <div class="col-4"><a class="" href="request.php"><img src="images/request books.png"></a><br>
                    <h3>Request New Books</h3>
                </div>

                <div class="col-4"><a class="" href="changePassword.php"><img src="images/password.png"></a><br>
